...
@section('content')
    ...
    <style>
        ...
        /* Prose */
        .geisha-section .prose {
            color: var(--text)
        }

        .geisha-section .prose p {
            margin: .75rem 0
        }

        .geisha-section .prose ul {
            list-style: none;
            padding: 0;
            margin: .75rem 0
        }
        ...
        <div class="container" bis_skin_checked="1"><h1>{{ __('meta.our_coffee') }}</h1>
            <ul class="breadcrumbs" typeof="BreadcrumbList" vocab="https://schema.org/">
                ...
                <li class="post post-page current-item"><span property="itemListElement" typeof="ListItem"><span
                            property="name">{{ __('meta.our_coffee') }}</span><meta property="position"
                                                                                    content="2"></span></li>
            </ul>
        </div>
    </header>
    ...
    <section class="geisha-section" aria-labelledby="geisha-title">
        ...
        <div class="geisha-wrap">
                ...
                <div>
                    ...
                    <div class="cta">
                        <a href="{{ LaravelLocalization::getLocalizedURL(app()->getLocale(),
                                                                    route('user.products', [], false)) }}" class="btn primary">{{ __('meta.coffee_v19') }}</a>
                    </div>
                ...
                <div class="features" style="margin-top:10px">
                    <div class="feat">
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path
                                d="M12 2a9 9 0 100 18 9 9 0 000-18zm0 2a7 7 0 110 14A7 7 0 0112 4zm1 3h-2v5l4 2 .8-1.8-2.8-1.2V7z"/>
                        </svg>
                        <div>
                    ...
                    <div class="feat">
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path d="M3 7h18v2H3V7zm0 4h12v2H3v-2zm0 4h18v2H3v-2z"/>
                        </svg>
                        <div>
                    ...
                    <div class="feat">
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path
                                d="M12 3l9 4v6c0 5-3.8 9.7-9 10-5.2-.3-9-5-9-10V7l9-4zm0 2.2L5 7.5v5.4c0 4.1 3 7.9 7 8.1 4-.2 7-4 7-8.1V7.5l-7-2.3zM7 12h10v2H7v-2z"/>
                        </svg>
                        <div>
            ...
            <section class="stats" style="margin-top:20px">
                <div class="stat card"><h3>12</h3>
                    <p>{{ __('meta.coffee_v46') }}</p></div>
                <div class="stat card"><h3>{{ __('meta.coffee_v47') }}</h3>
                    <p>{{ __('meta.coffee_v48') }}</p></div>
                <div class="stat card"><h3>1,400–1,700</h3>
                    <p>{{ __('meta.coffee_v49') }}</p></div>
                <div class="stat card"><h3>90+</h3>
                    <p>{{ __('meta.coffee_v50') }}</p></div>
            </section>
            ...
            <section class="grid grid-2 reverse" style="margin-top:20px">
                <figure class="map is-stretch">
                    <picture>
                        <source media="(max-width: 640px)" srcset="{{ asset('images/finca3pinos/montana2-640.webp') }}"
                                type="image/webp"/>
                        <source media="(max-width: 1024px)"
                                srcset="{{ asset('images/finca3pinos/montana2-1024.webp') }}" type="image/webp"/>
                        <source media="(max-width: 1366px)"
                                srcset="{{ asset('images/finca3pinos/montana2-1366.webp') }}" type="image/webp"/>
                        <source media="(max-width: 1920px)"
                                srcset="{{ asset('images/finca3pinos/montana2-1920.webp') }}" type="image/webp"/>
                        <source media="(min-width: 1921px)"
                                srcset="{{ asset('images/finca3pinos/montana2-2560.webp') }}" type="image/webp"/>
                        <img
