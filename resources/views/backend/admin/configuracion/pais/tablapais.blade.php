                            ...
                            @foreach($arrayPais as $dato)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br><br>
                                        <button type="button" class="btn btn-success btn-xs" onclick="vistaDepartamentos({{ $dato->id }})">
                                            <i class="fa fa-location-arrow" title="Departamentos"></i>&nbsp; Departamentos
                                        </button>
