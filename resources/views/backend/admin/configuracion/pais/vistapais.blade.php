                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" autocomplete="off" id="precio-nuevo" placeholder="Precio de Envío">
                                </div>
            ...
            <div class="modal-body">
                <form id="formulario-editar">
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Precio Envío</label>
                                <input type="number" class="form-control" autocomplete="off" id="precio-editar" placeholder="Precio de Envío">
                            </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('admin/paises/index/tabla') }}";
    ...
    <script>
        ...
        function guardarRegistro(){
            ...
            axios.post('/admin/paises/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function verInformacion(id){
            ...
            axios.post('/admin/paises/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $('#precio-editar').val(info.precio_envio);
        ...
        function editar() {
            ...
            axios.post('/admin/paises/editar', formData, {
            })
                .then((response) => {
                    closeLoading()
        ...
        function vistaDepartamentos(id){
            window.location.href="{{ url('/admin/departamentos/index') }}/"+id;
        }
