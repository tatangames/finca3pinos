...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var ruta = "{{ URL::to('admin/municipios/tabla') }}/" + iddepa;
    ...
    <script>
        ...
        function guardarRegistro(){
            ...
            axios.post('/admin/municipios/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function verInformacion(id){
            ...
            axios.post('/admin/municipios/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar() {
            ...
            axios.post('/admin/municipios/editar', formData, {
            })
                .then((response) => {
                    closeLoading()
