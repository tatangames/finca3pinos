                ...
                <div class="card">
                    <div class="card-body">
                        <table id="tabla" class="table table-bordered table-striped">
                            ...
                            @foreach($arrayDepartamentos as $dato)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br><br>
                                        <button type="button" class="btn btn-success btn-xs" onclick="vistaMunicipios({{ $dato->id }})">
                                            <i class="fa fa-location-arrow" title="Municipios"></i>&nbsp; Municipios
                                        </button>
